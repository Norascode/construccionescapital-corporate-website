    ...
    <footer className="bg-[#060a12] border-t border-white/10">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <ul className="flex flex-col gap-5">
              ...
              <li className="flex items-start gap-3">
                ...
                <div className="flex flex-col gap-0.5">
                  <span className="text-slate-400 text-sm">Villa de Aburrá, Laureles</span>
                  <span className="text-slate-400 text-sm">Medellín, Antioquia — Colombia</span>
                </div>
              </li>
              ...
              <li className="flex items-start gap-3">
                ...
                <div className="flex flex-col gap-0.5">
                  <span className="text-slate-400 text-sm">Lun – Vie: 8:00 AM – 6:00 PM</span>
                  <span className="text-slate-400 text-sm">Sáb: 9:00 AM – 2:00 PM</span>
                </div>
              </li>
          ...
          <div>
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15864.5!2d-75.5898!3d6.2442!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8e4429876543210%3A0x1234567890abcdef!2sLaureles%2C+Medell%C3%ADn%2C+Antioquia!5e0!3m2!1ses!2sco!4v1"
              width="100%"
              height="180"
